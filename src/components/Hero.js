...
const Hero = () => {
   ...
   return (
      <div className="hero h-0.7 relative">
         ...
         <div className="absolute right-5 top-1/2 transform -translate-y-1/2 sm:static">
            <MediaLinks displayType="grid grid-cols-1 gap-6 sm:hidden"/>
         </div>
         <div className="banner-text px-6 py-20 absolute top-1/2 transform -translate-y-1/2 sm:hidden">
